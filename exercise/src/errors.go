...
// Go’s approach makes it easy to see which functions return errors and to handle them using the same language constructs employed for any other,
// non-error tasks.
...
func main(){
	...
	_, e := f2(42)
	// The value of ok is true and false otherwise. ok is boolean
    ...
    // var ok = true
    // ok := true
    // boolean ok := true - check how to assign for this
    // if (ok){
    // 	fmt.Println("ae.prob")	
    // }
}
